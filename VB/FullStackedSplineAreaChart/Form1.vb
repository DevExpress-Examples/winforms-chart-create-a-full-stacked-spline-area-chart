...
Namespace FullStackedSplineAreaChart
    ...
    Public Partial Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Dim fullStackedSplineAreaChart As ChartControl = New ChartControl()
            ' Create two series of the FullStackedSplineArea view type.
            Dim series1 As Series = New Series("Series 1", ViewType.FullStackedSplineArea)
            Dim series2 As Series = New Series("Series 2", ViewType.FullStackedSplineArea)
